...
export const OriginView = () => {
  return (
    <section id="origin-section" aria-labelledby="origin-heading" className='col-span-12'>
      <div
        className="mt-24 flex w-full flex-col-reverse items-center justify-center gap-10 px-4 py-16 sm:px-8 lg:mt-0 lg:mb-10 lg:min-h-[500px] lg:flex-row lg:gap-5 lg:py-0 xl:mb-0 xl:gap-10">
